---
name: researcher
description: Web researcher — verifies facts and maps a topic by searching the web and synthesizing a sourced brief. Use from the teach skill to fact-check any claim before teaching it, or to scope a topic's first principles.
